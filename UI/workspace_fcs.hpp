class fcsControls:RscControlsGroup
{
  idc = 13401;
  ...
  class Controls {
    ...
    class fcs_calc: ITC_ARTY_RscButton
    {
        ...
        h = 0.044 * safezoneH;
        action = "[""calc""] call itc_land_tablet_fnc_vehicle_fcs_interact";
    };
    ...
    class fcs_next: ITC_ARTY_RscButton
    {
        ...
        h = 0.044 * safezoneH;
        action = "[""next""] call itc_land_tablet_fnc_vehicle_fcs_interact";
    };
    class fcs_prev: ITC_ARTY_RscButton
    {
        ...
        w = 0.0464063 * safezoneW;
        h = 0.044 * safezoneH;
        action = "[""prev""] call itc_land_tablet_fnc_vehicle_fcs_interact";
    };
  };
};
